...
public class NewMainGameplay : MonoBehaviour
{
    ...
    public GameObject _escapeObject;
    public TextMeshProUGUI _escapeText;
    public TextMeshProUGUI _buttonEscapeText;
    ...
    public Animator _fusionButtonAnim;
    public GameObject _pressEnterParent;
    ...
    {   
        ...
        _buttonEscapeText.text = GameInitScript.Instance.GetText("restart");
        _exitText.text = GameInitScript.Instance.GetText("exitmenu");
        _restartText.text = GameInitScript.Instance.GetText("spacebar");
    ...
    public void StartVoids()
    {
        ...
        _pressEnter.text = GameInitScript.Instance.GetText("pressenter");
    ...
    public IEnumerator StartGameNumerator()
    {
        ...
        MainController.Instance._atomPanelInfo._lockedBar.SetActive(false);
        MainController.Instance._atomPanelInfo._lockedBool = false;

        if (MainController.Instance._saveLoadValues._restartAvailable)
        {
        ...
        {
            MainController.Instance._firstWorld = false;
        }
        ...
        switch (Main._onWorldGlobal)
        {
            case 0:
                ...
                if (_idStage == 0)
                {
                    ...
                    yield return new WaitForSeconds(1);
                    Main._tutorialAssets._tutorialText.text = gi.GetText("reach").ToString();

                    string key1 = "reach".ToString();
                    ...
                    Main._tutorialAssets._elementsParent.SetActive(false);
                    Main._tutorialAssets._atomParent.SetActive(false);
                    Main._tutorialAssets._exitParent.SetActive(true);
                ...
                if (_idStage == 2)
                {
                        ...
                        yield return new WaitForSeconds(1);
                        Main._tutorialAssets._tutorialText.text = gi.GetText("princess1");

                        string key = "princess1".ToString();
                    //string text = GameInitScript.Instance.GetText(key);
                    string speakKey = key;
                        LOLSDK.Instance.SpeakText(speakKey);
                        ...
                        yield return new WaitForSeconds(1);
                        Main._tutorialAssets._tutorialText.text = gi.GetText("princess2");

                        string key2 = "princess2".ToString();
                    //string text = GameInitScript.Instance.GetText(key);
     ...
     /*       !_restartLocked*/)
        {
            ...
            _atomPanelMovementAvailable = _AtomsPanelOn;
        }


        else if (!MainController.Instance._exitAssets._exitPanelOn && _AtomsPanelOn && !MainController.Instance._atomPanelInfo._lockedBool)
        {
            AtomPanelController();
        }
    ...
    {
        var Main = MainController.Instance;
        if (_atomPanelMovementAvailable)
        {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            MainController.Instance._elementsAnimator[i].GetComponent<RectTransform>().localScale = new Vector3(0.3f, 0.3f, 1); 
        }


        if (_onPoseJoystick > 0)
        {
            MainController.Instance._elementsAnimator[_onPoseJoystick - 1].GetComponent<RectTransform>().localScale = new Vector3(0.4f, 0.4f, 1);
        }
   ...
   void ExitPanelController()
    {
        ...
        if(Input.GetAxisRaw("Vertical") < 0 && MainController.Instance._exitAssets._pos < 1 && !MainController.Instance._exitAssets._moves)
        {
...
._onTurnText.text = _allCountAttacks[i].ToString();
    ...
    public void SpecialRestartLevel()
    {
        ...
        if(_exitEntranceObjects.Count > 0)
        {
            Destroy(_exitEntranceObjects[0]);
            Destroy(_exitEntranceObjects[1]);
        ...
        _stepsList.Clear();
        MainController.Instance._saveLoadValues._totalSteps += _stepsCollected;
        int current = MainController.Instance._saveLoadValues._totalSteps + _stepsCollected;
        _slimeInfo._stepsText.text = current.ToString();
        _stepsCollected = 0;
    ...
    public IEnumerator NexttLevel()
    {
        ...
        if (Main._onWorldGlobal == 4 && _idStage == 3)
        {
        ...
        for (int i = 0; i < ElementInfo._elements.Length; i++)
        {
                ...
                if (!ElementInfo._elements[i]._changed)
                {
                    ...
                    if (!Main._saveLoadValues._elementTutorial)
                    {
                        ...
                        Main._tutorialAssets._stepParent.SetActive(false);
                        Main._tutorialAssets._exitParent.SetActive(false);
                        //Main._tutorialAssets._atomParent
                        Main._tutorialAssets._slimeParent.SetActive(false);
                    ...
                    if (ElementInfo._elements[i]._emptyAtom)
                    {
                        ...
                        string keya = "atom".ToString();
                        string speakKeya = keya;
                        LOLSDK.Instance.SpeakText(speakKeya);
                        ...
                        if (!Main._saveLoadValues._atomTutorial)
                        {
                            ...
                            //{
                                ...
                                _movementAvailable = false;
                                var gi = GameInitScript.Instance;
                                Main._tutorialAssets._tutorialText.text = gi.GetText("tutorialatom0");
                            string keyAtom0 = "tutorialatom0".ToString();
                            string speakKeyAtom0 = keyAtom0;
                            LOLSDK.Instance.SpeakText(speakKeyAtom0);
                            yield return new WaitForSeconds(1);
                                Main._tutorialAssets._tutorialAnimator.SetBool("TutorialIn", true);
                                Main._tutorialAssets._arrowsParent.SetActive(false);
                                Main._tutorialAssets._elementsParent.SetActive(false);
                            ...
                            yield return new WaitForSeconds(1);
                                ...
                                Main._tutorialAssets._tutorialText.text = gi.GetText("tutorialatom1");
                            string keyAtom1 = "tutorialatom1".ToString();
                            string speakKeyAtom1 = keyAtom1;
                            LOLSDK.Instance.SpeakText(speakKeyAtom1);
                            yield return new WaitForSeconds(1);
                                Main._tutorialAssets._tutorialAnimator.SetBool("TutorialIn", true);
                                Main._tutorialAssets._arrowsParent.SetActive(false);
                                Main._tutorialAssets._elementsParent.SetActive(false);
    ...
    public IEnumerator ElementNumerator()
    {
        ...
        //Debug.Log(_allAtoms.Count + "/" + _atomOnGame + "/" + _allElements.Count + "/" + MainController.Instance._saveLoadValues._fusionTutorial);
        ...
        if (_allAtoms.Count == 0 && _atomOnGame && _allElements.Count == 0)
        {
            ...
            switch (MainController.Instance._saveLoadValues._fusionTutorial)
            {
                case true:
                ...
                case false:
                    ...
                    string key2 = "tutorialatom2".ToString();
                    string speakKey2 = key2;
                    LOLSDK.Instance.SpeakText(speakKey2);
                    ...
                    Main._tutorialAssets._tutorialText.text = GameInitScript.Instance.GetText("tutorialatom3");
                    string key3 = "tutorialatom3".ToString();
                    string speakKey3 = key3;
                    LOLSDK.Instance.SpeakText(speakKey3);
                    yield return new WaitForSeconds(1);
                    Main._tutorialAssets._tutorialAnimator.SetBool("TutorialIn", true);
                    ...
                    _atomPanelMovementAvailable = true;
                    _restartLocked = false;
                    Main._saveLoadValues._fusionTutorial = true;
                    _SpecialLock = false;
                    break;
            }
    ...
    public IEnumerator TransormatioNumerator()
    {
        ...
        switch (_slimeInfo._slimeID)
        {
            ...
            case 3:
                ...
                string speakKey2 = key;
                LOLSDK.Instance.SpeakText(speakKey2);
                break;
            case 4:
                key = "ICE".ToString();

                string speakKey3 = key;
                LOLSDK.Instance.SpeakText(speakKey3);
                break;
            case 5:
                key = "FE304".ToString();
     
                string speakKey4 = key;
                LOLSDK.Instance.SpeakText(speakKey4);
                break;
        }
        ...
        MainController.Instance._atomPanelInfo._lockedBar.SetActive(true);
        MainController.Instance._atomPanelInfo._lockedBool = true;
        ...
        if (!MainController.Instance._saveLoadValues._hazardTutorial)
        {
            ...
            Main._tutorialAssets._atomParent.SetActive(false);
            Main._tutorialAssets._stepParent.SetActive(false);
            Main._tutorialAssets._slimeParent.SetActive(true);
            Main._tutorialAssets._tutorialAnimator.SetBool("TutorialIn", true);
    ...
    public IEnumerator ExitNumerator()
    {
        ...
        MainController.Instance._cinematicBorders.SetBool("FadeIn", true);
        MainController.Instance._saveLoadValues._totalSteps += _stepsCollected;
        int current = MainController.Instance._saveLoadValues._totalSteps;
        _slimeInfo._stepsText.text = current.ToString();
        _stepsCollected = 0;
        yield return new WaitForSeconds(1);
        switch (_idStage == Main._allTurnsInfo[Main._onWorldGlobal]._stagesID.Count - 1)
    ...
    public void FinalTimerVoid()
    {
        MainController.Instance._finalTimerAssets._timerText.gameObject.SetActive(MainController.Instance._finalTimerAssets._timerOn);
        if (MainController.Instance._finalTimerAssets._timerOn && !MainController.Instance._exitAssets._exitPanelOn)
        {
            MainController.Instance._finalTimerAssets._timer -= Time.deltaTime;
            MainController.Instance._finalTimerAssets._timerText.text = MainController.Instance._finalTimerAssets._timer.ToString("f2");
            if (MainController.Instance._finalTimerAssets._timer <= 0 && !_timerEnds)
            {
                StartCoroutine(TimerExitNumerator());
            }
        }
    ...
    public IEnumerator TimerExitNumerator()
    {
        _timerEnds = true;
        var Main = MainController.Instance;
        MainController.Instance._finalTimerAssets._timerOn = false;
        ...
        SFXscript.Instance._strongWindSetVolume = 0f;
        _slimeObject.GetComponent<Animator>().Play("SlimeDies");
        Main._scriptMusic._audioBGM.Stop();
        Main._scriptSFX.PlaySound(Main._scriptSFX._slimeDead);
        _deadSlimeParticle.Play();
        _gameStarts = false;
        MainController.Instance._bordersAnimator.SetBool("BorderOut", false);
    ...
    public IEnumerator TremorNumerator()
    {
        _mainUI.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 2);
        yield return new WaitForSeconds(0.1f);
        _mainUI.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 0);
    }
